...
sysconfdir = "/Users/kaungkhantlin/Developer/1_2025/programming-languages/miniProject2/haskell/bfs/.stack-work/install/aarch64-osx/c78f44e280091ae3ad87365000415eeba04bd5428fcc403b489b919ce70727d6/9.10.2/etc"

getBinDir     = catchIO (getEnv "bfs_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "bfs_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "bfs_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "bfs_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "bfs_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "bfs_sysconfdir") (\_ -> return sysconfdir)
